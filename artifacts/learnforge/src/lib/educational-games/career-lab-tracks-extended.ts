...
console.log(user.name.toUpperCase())`,
...

    {
      ...
      content: {
        terminal: {
          ...
          commandOutputs: {
            "show units": [
              "UNIT ID   ZONE          MODE     STATUS   TEMP-SP",
              "────────  ────────────  ───────  ───────  ───────",
              "AHU-1     Lobby         COOLING  ONLINE   72°F",
              "AHU-2     Office Ste B  COOLING  FAULT    72°F   ← HPL lockout",
              "AHU-3     Server Room   COOLING  ONLINE   68°F",
              "FCU-1     Conf Room A   COOLING  ONLINE   74°F",
            ].join("\n"),
            "show faults ahu-2": [
              "FAULT LOG — AHU-2  (last 24 h)",
              "────────────────────────────────────────",
              "08:04  HPL  High-Pressure Lockout  ACTIVE",
              "         Discharge pressure exceeded 400 PSI threshold.",
              "         Unit locked out. Manual reset required.",
              "08:03  HPS  High-Pressure Switch OPEN",
              "07:15  NRM  Normal operation — no faults",
            ].join("\n"),
            "show temps ahu-2": [
              "AHU-2 Temperature Readings",
              "  Supply Air (SA):  81.4°F  [setpoint 55°F]  ← NO COOLING",
              "  Return Air (RA):  76.2°F",
              "  Delta-T:          -5.2°F  [expected -20 to -25°F]",
              "  Refrigerant HP:   412 PSI [limit 400 PSI] ← OVER LIMIT",
              "  Refrigerant LP:   68 PSI  [normal 60-80 PSI]",
            ].join("\n"),
            "reset fault ahu-2 hpl": [
              "Sending HPL reset command to AHU-2...",
              "  → High-Pressure Lockout cleared.",
              "  → Contactor re-energised.",
              "  → Compressor starting sequence initiated.",
              "Reset successful. Monitor pressures for 90 seconds.",
            ].join("\n"),
            "set mode ahu-2 cooling": [
              "AHU-2 mode → COOLING",
              "  Thermostat call:   ACTIVE (Zone T-stat 76°F > SP 72°F)",
              "  Compressor stage:  1 of 2  running",
              "  Discharge pressure: 298 PSI ✓",
              "Mode set. Unit AHU-2 entering normal cooling operation.",
            ].join("\n"),
            "show status ahu-2": [
              "AHU-2 Status Report",
              "  Mode:            COOLING  ✓",
              "  Compressor:      RUNNING  ✓",
              "  Supply Air Temp: 57.1°F   ✓ (SP 55°F)",
              "  Return Air Temp: 76.0°F",
              "  Discharge Press: 301 PSI  ✓",
              "  Active Faults:   NONE     ✓",
              "Unit AHU-2 is operating normally. Ticket #7821 may be closed.",
            ].join("\n"),
          },
        },
      },
    ...
    },
    {
      ...
      content: {
        terminal: {
          ...
          commandOutputs: {
            "patient lookup lee kim": [
              "Patient Found",
              "  Name:      Kim Lee (DOB 1991-04-22)",
              "  ID:        PT-009923",
              "  Allergies: NKDA",
              "  Insurance: BlueCross PPO  Group 4421  ID BCBS-9923",
              "  Last Rx:   2025-11-14 — azithromycin 250 mg",
            ].join("\n"),
            "prescriber verify 9988776655": [
              "NPI Lookup — 9988776655",
              "  Provider:    Dr. S. Park, MD",
              "  Specialty:   Family Medicine",
              "  DEA:         BP2290033  ✓ active",
              "  State Lic:   NV-98823   ✓ active",
              "Prescriber verified. Credentials on file match Rx.",
            ].join("\n"),
            "rx new amoxicillin 500mg qty 21 days 7": [
              "New Rx Created",
              "  Rx #:      48293",
              "  Patient:   Kim Lee  PT-009923",
              "  Drug:      Amoxicillin 500 mg Capsules",
              "  Sig:       1 cap by mouth three times daily",
              "  Qty:       21  |  Days supply: 7",
              "  Prescriber: Dr. S. Park  NPI 9988776655",
              "Rx 48293 staged — run DUR before dispensing.",
            ].join("\n"),
            "rx dur": [
              "Drug Utilization Review — Rx 48293",
              "  Drug-Drug Interactions:  NONE",
              "  Drug-Allergy Check:      PASS  (NKDA on file)",
              "  Duplicate Therapy:       NONE",
              "  Age/Sex Appropriateness: OK",
              "DUR CLEAR — no alerts. Proceed to adjudication.",
            ].join("\n"),
            "rx adjudicate primary": [
              "Submitting Rx 48293 to BlueCross PPO...",
              "  Plan Response:   PAID",
              "  Plan Pays:       $18.40",
              "  Patient Copay:   $5.00",
              "  Claim #:         BCBS-TXN-883241",
              "Adjudication successful. Collect $5.00 at pickup.",
            ].join("\n"),
            "rx print label": [
              "Sending label to DYMO-LX810...",
              "  ┌──────────────────────────────────────┐",
              "  │ AMOXICILLIN 500 MG CAPSULES          │",
              "  │ Kim Lee                               │",
              "  │ Take 1 capsule by mouth 3x daily     │",
              "  │ Qty: 21   Exp: 2026-02-19            │",
              "  │ Dr. S. Park  Rx# 48293               │",
              "  └──────────────────────────────────────┘",
              "Label printed. Route to pharmacist for final check.",
            ].join("\n"),
          },
        },
      },
...

    {
      ...
      content: {
        terminal: {
          ...
          commandOutputs: {
            "encounter open e-4421": [
              "Encounter E-4421",
              "  Patient:    Nguyen, Linh  (DOB 1985-07-10)",
              "  Provider:   Dr. A. Patel, MD  NPI 1234567890",
              "  Facility:   Westside Family Clinic",
              "  DOS:        2026-03-15",
              "  Visit type: Established patient — office visit",
              "  Chief Cx:   Scalp laceration — fell at home",
              "  Insurance:  BCBS PPO  (primary)",
              "Encounter opened. No CPT/ICD codes assigned yet.",
            ].join("\n"),
            "code add cpt 99213": [
              "CPT Added",
              "  Code:    99213",
              "  Desc:    Office visit, est. patient — low complexity MDM",
              "  RVU:     1.30",
              "99213 added to E-4421.",
            ].join("\n"),
            "code add cpt 12001": [
              "CPT Added",
              "  Code:    12001",
              "  Desc:    Simple repair of superficial wounds, scalp ≤2.5 cm",
              "  RVU:     2.19",
              "12001 added to E-4421.",
            ].join("\n"),
            "code modifier 99213 25": [
              "Modifier Applied",
              "  CPT:      99213",
              "  Modifier: 25 — Significant, separately identifiable E/M",
              "            same day as another procedure.",
              "Modifier 25 appended to 99213.",
            ].join("\n"),
            "code add icd s01.01xa": [
              "ICD-10-CM Added",
              "  Code:    S01.01XA",
              "  Desc:    Unspecified open wound of scalp, initial encounter",
              "S01.01XA set as primary diagnosis for E-4421.",
            ].join("\n"),
            "claim validate e-4421": [
              "Clean-Claim Validation — E-4421",
              "  [✓]  Patient demographics complete",
              "  [✓]  Provider NPI on file",
              "  [✓]  DOS and place of service populated",
              "  [✓]  Diagnosis linked to each procedure",
              "  [✓]  Modifier 25 on 99213 — E/M/procedure same-day OK",
              "  [✓]  No NCCI edit conflicts",
              "VALIDATION PASSED — 0 errors, 0 warnings.",
              "Claim is clean and ready to submit.",
            ].join("\n"),
            "claim submit e-4421 primary": [
              "Submitting E-4421 to BCBS PPO...",
              "  Transmission:  837P electronic claim",
              "  Payer ID:      00041",
              "  Tracking #:    BCBS-234-8821",
              "  Status:        ACCEPTED — pending adjudication",
              "Claim submitted successfully. Expected EOB in 14 days.",
            ].join("\n"),
          },
        },
      },
  ...
  "it-support": [
          ...
          steps: [
            {
              ...
              hint: "ipconfig /all",
              notes: "ipconfig /all shows every adapter's MAC, DHCP lease, DNS servers, and IP — the most informative first step in any Windows network ticket.",
            },
            {
              instruction: "Test connectivity to the default gateway (192.168.1.1).",
              expectedCommand: "ping 192.168.1.1",
              hint: "ping 192.168.1.1",
              notes: "Pinging the default gateway tests Layer 3 reachability to your router. If this fails, the problem is LAN-side — not the ISP.",
            },
            {
              instruction: "Test external connectivity to Google's DNS server.",
              expectedCommand: "ping 8.8.8.8",
              hint: "ping 8.8.8.8",
              notes: "Reaching an external IP bypasses DNS entirely. Success here but failure on nslookup isolates a DNS-only problem.",
            },
            {
              instruction: "Resolve a hostname to verify DNS is working.",
              expectedCommand: "nslookup google.com",
              hint: "nslookup google.com",
              notes: "nslookup queries the configured DNS server directly, bypassing the OS resolver cache — useful for isolating stale-cache vs server failure.",
            },
            {
              instruction: "Flush the local DNS resolver cache.",
              expectedCommand: "ipconfig /flushdns",
              hint: "ipconfig /flushdns",
              notes: "The DNS resolver cache stores recent lookups. Stale or TTL-expired entries cause intermittent failures even when the DNS server is healthy.",
            },
            {
              instruction: "Request a new DHCP lease.",
              expectedCommand: "ipconfig /renew",
              hint: "ipconfig /renew",
              notes: "DHCP renew requests a fresh IP lease from the server, resolving duplicate-IP conflicts and APIPA fallback addresses (169.254.x.x).",
            },
          ],
        },
      },
    ...
    {
      id: "its-net-gateway-repair",
      title: "🔧 Fix-It: Wrong Default Gateway",
      description:
        "A Windows workstation lost internet access after a network reconfiguration. The static IP was given the wrong gateway. Diagnose with ipconfig and netsh, apply the correct settings, then verify connectivity is restored.",
      gameType: "terminal-workspace",
      duration: "8–12 min",
      ...
      content: {
        terminal: {
          ...
          brief:
            "Help desk ticket #5503: 'My PC had internet this morning, now nothing loads — but I can still open files on the shared drive.' A static IP change was pushed last night. Something is misconfigured. Diagnose and fix.",
          hostname: "WIN-PC-07",
          prompt: "C:\\Users\\student>",
          initialOutput: [
            "Microsoft Windows [Version 10.0.19045]",
            "Help desk ticket #5503: Internet access lost after network reconfiguration.",
            "LAN shared drive still reachable. Internet and gateway unreachable.",
          ].join("\n"),
          steps: [
            {
              instruction: "Display the full IP configuration to check the current static settings.",
              expectedCommand: "ipconfig /all",
              hint: "ipconfig /all",
              notes: "The Default Gateway field routes all traffic destined for other subnets. A wrong-VLAN gateway lets LAN work but silently blocks internet.",
            },
            {
              instruction: "Ping the misconfigured gateway (192.168.100.1) to confirm it is unreachable.",
              expectedCommand: "ping 192.168.100.1",
              hint: "ping 192.168.100.1",
              notes: "Pinging the stated gateway is diagnostic only — a 100% timeout confirms it's unreachable from this subnet and justifies the config change.",
            },
            {
              instruction: "Show the detailed netsh IP config for the Ethernet adapter to see the full static config.",
              expectedCommand: "netsh interface ip show config \"Ethernet\"",
              hint: "netsh interface ip show config \"Ethernet\"",
              notes: "netsh gives structured output that's easier to script than ipconfig, and explicitly shows whether the address source is DHCP or static.",
            },
            {
              instruction: "Fix the gateway: assign the correct static address (192.168.1.45 / 255.255.255.0 / gateway 192.168.1.1).",
              expectedCommand:
                "netsh interface ip set address name=\"Ethernet\" static 192.168.1.45 255.255.255.0 192.168.1.1",
              hint: "netsh interface ip set address name=\"Ethernet\" static 192.168.1.45 255.255.255.0 192.168.1.1",
              notes: "netsh ip set address applies IP, subnet mask, and gateway atomically in a single command — no reboot required.",
            },
            {
              instruction: "Confirm the correct gateway now responds to ping.",
              expectedCommand: "ping 192.168.1.1",
              hint: "ping 192.168.1.1",
              notes: "Always test the new gateway before testing internet — it isolates whether the fix reached the router vs a further upstream problem.",
            },
            {
              instruction: "Verify internet access is restored by pinging Google's public DNS.",
              expectedCommand: "ping 8.8.8.8",
              hint: "ping 8.8.8.8",
              notes: "End-to-end internet ping confirms the full routing path is restored through the corrected default gateway.",
            },
          ],
          commandOutputs: {
            "ipconfig /all": [
              ...
              "   Default Gateway: 192.168.100.1   ← WRONG VLAN — should be 192.168.1.1",
              "   DNS Servers:  8.8.8.8",
              "   DHCP Enabled: No  (static config)",
              "",
              "→ Gateway 192.168.100.1 is on a different subnet. Internet traffic cannot route.",
            ].join("\n"),
            "ping 192.168.100.1": [
              ...
              "→ Gateway 192.168.100.1 is unreachable. Confirms wrong gateway setting.",
            ].join("\n"),
            "netsh interface ip show config \"ethernet\"": [
              ...
              "    Default Gateway:                      192.168.100.1   ← WRONG",
              "    Gateway Metric:                       0",
              "    DNS servers:                          8.8.8.8",
              "",
              "→ Default gateway points to 192.168.100.1 (VLAN 100 — not this subnet).",
              "   Correct gateway is 192.168.1.1. Apply fix with netsh set address.",
            ].join("\n"),
            "netsh interface ip set address name=\"ethernet\" static 192.168.1.45 255.255.255.0 192.168.1.1": [
              "Ok.",
              "",
              ...
              "  Subnet Mask:  255.255.255.0",
              "  Gateway:      192.168.1.1  ✓",
              "Network stack updated. Testing connectivity…",
            ].join("\n"),
            "ping 192.168.1.1": [
              ...
              "→ Gateway 192.168.1.1 is reachable. ✓",
            ].join("\n"),
            "ping 8.8.8.8": [
              ...
              "    Packets: Sent = 4, Received = 4, Lost = 0 (0% loss)",
              "→ Internet access restored. Ticket #5503 resolved. ✓",
            ].join("\n"),
          },
        },
      },
          ...
          steps: [
            {
              ...
              notes: "bcdedit /enum all reveals every BCD store entry including orphaned GUIDs — plain /enum only shows the current default boot path.",
            },
            {
              instruction: "Repair the Master Boot Record.",
              expectedCommand: "bootrec /fixmbr",
              hint: "bootrec /fixmbr",
              notes: "The MBR is the first 512 bytes of the boot disk. Corruption here prevents any OS from loading, regardless of BCD state.",
            },
            {
              instruction: "Repair the boot sector on the system partition.",
              expectedCommand: "bootrec /fixboot",
              hint: "bootrec /fixboot",
              notes: "The partition boot sector is separate from the MBR. /fixmbr and /fixboot together cover both stages of the pre-bootloader chain.",
            },
            {
              ...
              notes: "rebuildbcd scans all partitions for Windows installations and rewrites the BCD — the critical step when boot entries are corrupt or missing.",
            },
            {
              ...
              hint: "bcdedit /enum",
              notes: "Always re-enumerate after repair to confirm {current} has a valid device and path before removing the install media and rebooting.",
            },
          ],
          commandOutputs: {
            "bcdedit /enum all": [
          ...
          steps: [
            {
              ...
              expectedCommand: "systemctl status nginx",
              hint: "systemctl status nginx",
              notes: "systemctl status includes the last few journal lines inline — often enough to identify the failure without opening syslog or journalctl.",
            },
            {
              instruction: "Run nginx's built-in config test to locate the exact error.",
              expectedCommand: "nginx -t",
              hint: "nginx -t",
              notes: "nginx -t validates syntax without touching live traffic. Always run it before restarting — never restart a service after a blind config change.",
            },
            {
              ...
              notes: "grep -n returns line numbers so the sed substitution can be targeted precisely and verified before applying.",
            },
            {
              instruction:
              ...
              notes: "sed -i edits in-place. This substitution is idempotent — running it twice leaves the file correct, which matters for automation scripts.",
            },
            {
              instruction: "Restart nginx to apply the corrected config.",
              expectedCommand: "systemctl restart nginx",
              hint: "systemctl restart nginx",
              notes: "Restart (not reload) is needed here: worker count is set at process spawn time and a reload only re-reads server blocks and upstreams.",
            },
            {
              instruction: "Verify the web server responds on localhost.",
              expectedCommand: "curl localhost",
              hint: "curl localhost",
              notes: "curl localhost confirms the service is actually handling HTTP — systemctl 'active' only means the process is running, not that it accepts connections.",
            },
          ],
          commandOutputs: {
